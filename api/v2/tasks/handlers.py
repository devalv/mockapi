...
from api.v2.tasks.schemas import TaskShortModel, TaskShortResponseModel
...
# TODO: is-done task  автору задачи и администратору, обертка над task в булевом формате
